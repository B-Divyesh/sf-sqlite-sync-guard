...
- Recording: `site/public/demo-recording.svg` is generated from `sqlite-sync-guard demo`. Its companion text file replaces only the random temporary workspace path with `<demo-workspace>`.
